...
namespace OpenDb2.Services
{
    ...
    {
        public static IServiceCollection AddWinDb2Services(this IServiceCollection services, string connectionString)
        {
        ...
        public static IServiceCollection AddLnxDb2Services(this IServiceCollection services, string connectionString)
        {
